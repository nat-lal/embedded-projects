...
def on_connect(client, userdata, flags, rc):
    ...
    client.message_callback_add("audio", audio_callback)

def on_message(client, userdata, msg):
    print("on_message: " + msg.topic + " " + str(msg.payload, "utf-8"))

def audio_callback(client, userdata, msg):
    samples = []
    buffer = []
    ...
    wavio.write("output.wav", samples, 44100, sampwidth=4)
    global audioReceived
    audioReceived = True
